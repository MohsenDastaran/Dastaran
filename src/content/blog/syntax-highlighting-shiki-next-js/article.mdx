...
If you are just interested in the final outcome, you can find the code for this blog post in my repository <ProfileBadge platform="GitHub" handle="MohsenDastaran/shiki-nextjs">MohsenDastaran/shiki-nextjs</ProfileBadge>.
...
I also incorporated a "Copy to Clipboard" button into the code components on this site. If you're interested in how to implement this feature, you can check out the complete code on <ProfileBadge platform="GitHub" handle="MohsenDastaran/shiki-nextjs">MohsenDastaran/shiki-nextjs</ProfileBadge>.
