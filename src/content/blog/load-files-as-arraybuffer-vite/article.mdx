...
description: "How to load files like fonts as ArrayBuffers in Vite, with an example for embedding custom fonts when using Satori or @vercel/og for dynamic OG images."
publicationDate: "2025-08-11T20:15:00Z"
...
```tsx /InterLatin400/ /InterLatin700/ filename="app/routes/api/og-image.tsx" showLineNumbers=4
