...
description: "Learn how to automatically generate a sitemap.xml file for your React Router 7 or Remix app using minimal configuration with this step-by-step guide."
...
<Alert type="question" title="Why automate your sitemap?">
...
2.  The `generateRemixSitemap()` helper function takes your route definitions and creates a valid sitemap.
    <Alert type="info">
      Because the package is built for Remix v2, the function automatically
...
3.  The `ignore` option excludes routes you don’t want indexed (like API endpoints or legal pages).
    <Alert type="question" title="Why ignore some routes?">
...
<Alert type="warning" title="Duplicate route registration">
