...
description: "Learn how to implement a honeypot to protect your form from spam submissions by AI or regular bots."
publicationDate: "2025-09-29T08:00:00Z"
tags: ["Honeypot", "Anti-Spam", "React Router 7", "Tips and Tricks"]
cover: "./form-spam-submissions.webp"
---
...
With a honeypot, you add a hidden `<input>{:html}` field, so real users don’t notice it.  
Bots usually fill it in, letting you filter out those submissions.
...
Upon validation (best on server-side), you simply check whether the honeypot field has been filled in and ignore the submission if it has.
...
Here are a few tips that made my honeypots effective:
...
Choose a common field name like _"company"_ or _"website"_, something that looks normal for your type of form but isn’t actually needed.
...
<Alert type="question" title="Why not use autocomplete=off?">
...
Here’s a simplified version of [my own newsletter signup form](https://github.com/MohsenDastaran/Dastaran/blob/main/app/components/NewsletterForm.tsx):
...
![Honeypot events tracked with Vercel Analytics](honeypot-events.png)
